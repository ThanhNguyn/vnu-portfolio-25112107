...
export const projectFilesMap: Record<string, FileNode[]> = {
  ...
  "week-04": [
    ...
    { name: "report.css", path: "report.css", type: "file" },
    {
      ...
      path: "Todo_App_Project",
      type: "directory",
      children: [
        { name: "index.html", path: "Todo_App_Project/index.html", type: "file" },
        { name: "app.js", path: "Todo_App_Project/app.js", type: "file" },
        { name: "style.css", path: "Todo_App_Project/style.css", type: "file" }
      ]
    }
  ],
  "week-05": [
